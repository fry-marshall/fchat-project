...
class UpdateDescriptionPage extends StatefulWidget {
  ...
  UpdateDescriptionPage({required this.description});
  @override
  State<UpdateDescriptionPage> createState() => UpdateDescriptionPageState();
}

class UpdateDescriptionPageState extends State<UpdateDescriptionPage> {
