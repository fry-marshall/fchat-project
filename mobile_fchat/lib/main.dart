...
Future<void> main() async {
  ...
  await FirebaseNotificationService().requestPermision();

  FirebaseNotificationService().handleNotifications();
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {'/authentification': (context) => AuthenticationPage()},
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
          seedColor: Color.fromRGBO(50, 133, 210, 1),
        ).copyWith(primary: Color.fromRGBO(50, 133, 210, 1)),
      ),
      home: HomePage(),
    );
  }
